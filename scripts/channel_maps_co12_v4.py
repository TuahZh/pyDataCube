...
#column density 
    ...
    if (i==1):
        box_center = (249.71795, -46.9626083)
        radius_box1 = 0.07052361/2.
        radius_box2 = 0.11979167/2.
        box0 = (box_center[0]-radius_box1, box_center[1]-radius_box2)
        box1 = (box_center[0]+radius_box1, box_center[1]-radius_box2)
        box2 = (box_center[0]+radius_box1, box_center[1]+radius_box2)
        box3 = (box_center[0]-radius_box1, box_center[1]+radius_box2)
        vertices = []
        codes = []
        codes = [Path.MOVETO] + [Path.LINETO]*3 + [Path.CLOSEPOLY]
        vertices = array([box0, box1, box2, box3, (0,0)], float)
        path = Path(vertices, codes)
        pathpatch =  PathPatch(path, facecolor='None', edgecolor='green', linestyle='dashed')
        ax["fk5"].add_patch(pathpatch)
