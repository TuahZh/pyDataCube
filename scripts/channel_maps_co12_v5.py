...
#column density 
    if (i==0):
        plt_line = ax["fk5"].plot([ledge1[0],redge1[0]],[ledge1[1],redge1[1]],'--', 
        #color='#ff6000'
        color='white')
        plt_line = ax["fk5"].plot([ledge2[0],redge2[0]],[ledge2[1],redge2[1]],'--', 
        #color='#ff6000'
        color='white')

    box1=(249.66589,-47.022273)
    box2=(249.76975,-46.901649)
    vertices=[]
    codes=[]
    codes=[Path.MOVETO]+[Path.LINETO]*3+[Path.CLOSEPOLY]
    vertices=array([box1,(box1[0],box2[1]),box2,(box2[0],box1[1]),(0,0)], float)
    path = Path(vertices, codes)
    pathpatch = PathPatch(path, facecolor='None', edgecolor='white', linestyle='dashed')
    if (i==1):
...
savefig("co12_channel_maps_%d"%vcut_for_name+"_v6.eps",
